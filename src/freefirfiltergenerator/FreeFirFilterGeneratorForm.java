...
public class FreeFirFilterGeneratorForm extends javax.swing.JFrame {
    ...
    private AboutWindow aboutForm = new AboutWindow();
    private String saveImpulsePath = "";
    ...
    private void initComponents() {
        ...
        jSpinnerFilterGroupDelay.setEnabled(false);
        ...
        jCheckBoxFilterGroupDelay.setEnabled(false);
        ...
        jLabelWindowing.setText("Window type");
    ...
    private void jMenuSaveFilterImpulseResponseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuSaveFilterImpulseResponseActionPerformed
        ...
        if(result == JFileChooser.APPROVE_OPTION) {
            ...
            try { 
                    ...
                    saveImpulsePath = file.getPath();
                    System.out.println(saveImpulsePath);
    ...
    private void loadSettings() {
       ...
       // this.jLabelLatencyValue.setText(prefs.get("jLabelLatencyValue", ""));
        ...
        saveImpulsePath = prefs.get("saveImpulsePath", "");
    }
    ...
    private void saveSettings() {
       ...
       // prefs.put("jLabelLatencyValue", this.jLabelLatencyValue.getText());
        ...
        prefs.put("saveImpulsePath", saveImpulsePath);
    }
